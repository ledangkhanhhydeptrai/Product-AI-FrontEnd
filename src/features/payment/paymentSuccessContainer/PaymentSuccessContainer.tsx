...
import { successPaymentRequest } from "../paymentSlice";
...
const PaymentSuccessContainer: React.FC = () => {
  ...
  useEffect(() => {
    ...
    dispatch(successPaymentRequest({ order_code: code }));
      ...
      <div className="w-full max-w-md bg-[#fffdf8] rounded-3xl shadow-[0_8px_30px_rgba(61,44,30,0.08)] overflow-hidden">
        ...
        <div className="bg-[#3d2c1e] py-8 flex flex-col items-center">
          <div className="relative">
            ...
            <div className="relative w-20 h-20 rounded-full bg-emerald-50 flex items-center justify-center ring-4 ring-emerald-100/40">
              <CheckCircle2
        ...
        <div className="px-6 sm:px-8 py-8 text-center">
          ...
          <button
            onClick={() => navigate("/")}
            className="mt-6 w-full inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-full bg-[#3d2c1e] text-[#fffdf8] text-sm font-medium hover:bg-[#2a1f15] active:scale-[0.98] transition-all"
          >
            Về trang chủ ngay
          </button>
        </div>
